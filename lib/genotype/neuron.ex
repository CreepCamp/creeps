defmodule Genotype.Neuron do 
	...
	# not sure this is usefull ... Might be better with GenServer anyway ...
	# def create(neuron) do 
	# 	Agent.start_link(fn -> neuron end)
	# end

	# def create() do 
	# 	Agent.start_link(fn -> %Genotype.Neuron{} end)
	# end

	# def get(pid) do 
	# 	Agent.get(pid, fn(neuron) -> neuron end)
	# end

	# def update(pid, neuron) do 
	# 	Agent.update(pid, fn(_)-> neuron end)
	# end
